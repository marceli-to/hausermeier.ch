		...
		<nav class="site-nav" :class="{'is-visible': menuVisible}">
			...
			<ul>
				<li>
					...
					<ul>
						<li>
							<router-link :to="{ name: 'home-grids' }">Layout</router-link>
						</li>
						<li>
				...
				<li>
					<router-link :to="{ name: 'projects' }" class="is-parent">Projekte</router-link>
					<ul>
						<li>
							<router-link :to="{ name: 'project-program' }">Thema</router-link>
						</li>
						<!-- <li>
							<router-link :to="{ name: 'project-intro'}">Intro S&amp;E</router-link>
						</li> -->
					</ul>
				</li>
				<li>
					...
					<ul>
						<li>
							<router-link :to="{ name: 'strategy-intro'}">Intro</router-link>
						</li>
						<li>
							<router-link :to="{ name: 'strategy-projects' }">Projekte</router-link>
						</li>
					</ul>
				</li>
				<li>
					<router-link :to="{ name: 'discourses' }" class="is-parent">Aktuell</router-link>
					<!-- <ul>
						<li>
							<router-link :to="{ name: 'discourse-topic' }">Kategorien</router-link>
						</li>
					</ul> -->
				</li>
				<li>
					...
					<ul>
						<li>
							<router-link :to="{ name: 'interaction-intro'}">Intro</router-link>
						</li>
						<li>
							<router-link :to="{ name: 'interaction-projects' }">Projekte</router-link>
						</li>
					</ul>
				</li>
				<li>
					<router-link :to="{ name: 'team' }" class="is-parent">Team</router-link>
					<ul>
						<li>
				...
				<li>
					<router-link :to="{ name: 'profile' }" class="is-parent">Profil</router-link>
					<ul>
						<li>
