  ...
  <div>
    ...
    <div class="container">
      <main class="content" role="main">
        <div>
          <h1>Projekt - Strategie &amp; Entwicklung - Intro</h1>
          <router-link :to="{ name: 'project-intro-create' }" class="btn-add">
          ...
          <div class="list-items" v-if="intro">
            ...
            >
              ...
              <div class="list-item-action" data-icons="3">
                ...
                ></a>
                <router-link
                  :to="{name: 'project-intro-edit', params: { id: i.id }}"
...
export default {
  ...
  methods: {
    ...
    fetch() {
      this.axios.get(`/api/intro/get/se`).then(response => {
