        ...
        <form @submit.prevent="submit">
          ...
          <footer class="site-footer">
            <div>
              ...
              <router-link :to="{name: 'project-intro'}">Zurück</router-link>
            </div>
          </footer>
        </form>
      </div>
...
// Config
import introTabs from "@/components/projects/intro/config/tabs.js";
import introErrors from "@/components/projects/intro/config/errors.js";
  ...
  methods: {
    ...
    store() {
      ...
      this.axios.post(uri, this.intro).then(response => {
        this.$router.push({ name: "project-intro" });
