        ...
        <form @submit.prevent="submit">
          ...
          <footer class="site-footer">
            <div>
              ...
              <router-link :to="{name: 'strategy-intro', params: { type: this.intro.type }}">Zurück</router-link>
            </div>
          </footer>
        </form>
      </div>
...
// Config
import introTabs from "@/components/strategy/intro/config/tabs.js";
import introErrors from "@/components/strategy/intro/config/errors.js";
  ...
  methods: {
    ...
    store() {
      ...
      this.axios.post(uri, this.intro).then(response => {
        this.$router.push({ name: "strategy-intro" });
  ...
  computed: {
    title: function() {
      return this.$props.type == "edit"
        ? "Intro Strategie & Entwicklung bearbeiten"
        : "Intro Strategie & Entwicklung hinzufügen";
    }
  }
};
</script>