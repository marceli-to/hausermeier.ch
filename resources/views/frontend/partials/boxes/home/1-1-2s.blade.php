    ...
    <div class="box__a">
      <div>
        @if (isset($elements[0]))
          ...
          @endif
          @if ($elements[0]->image)
            @include('frontend.partials.boxes.home.image', array('image' => $elements[0]->image, 'image_attribute' => 'height="639" width="450"'))
          @endif
    ...
    <div class="box__a">
      <div>
        @if (isset($elements[1]))
          ...
          @endif
          @if ($elements[1]->image)
            @include('frontend.partials.boxes.home.image', array('image' => $elements[1]->image, 'image_attribute' => 'height="639" width="450"'))
          @endif
  ...
  <div>
    <div class="box__d">
      <div>
        @if (isset($elements[2]))
          @if ($elements[2]->image)
            @include('frontend.partials.boxes.home.image', array('image' => $elements[2]->image, 'image_attribute' => 'height="312" width="450"'))
          @endif
          @if ($elements[2]->news)
    ...
    <div class="box__d">
      <div>
        @if (isset($elements[3]))
          @if ($elements[3]->image)
            @include('frontend.partials.boxes.home.image', array('image' => $elements[3]->image, 'image_attribute' => 'height="312" width="450"'))
          @endif
          @if ($elements[3]->news)
