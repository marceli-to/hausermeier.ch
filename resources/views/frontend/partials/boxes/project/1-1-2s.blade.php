    ...
    <div class="box__a">
      <div>
        @if (isset($elements[1]))
          ...
          @endif
          @if ($elements[1]->image)
            @include('frontend.partials.boxes.project.image', array('image' => $elements[1]->image, 'image_attribute' => 'height="639" width="450"'))
          @endif
        @endif
      </div>
    </div>
  ...
  <div>
    ...
    <div class="box__d">
      <div>
        @if (isset($elements[3]))
          @if ($elements[3]->text)
            @include('frontend.partials.boxes.project.text', array('text' => $elements[3]->text))
          @endif
          @if ($elements[3]->image)
            @include('frontend.partials.boxes.project.image', array('image' => $elements[3]->image, 'image_attribute' => 'height="312" width="450"'))
          @endif
        @endif
      </div>
    </div>
