    ...
    <div class="box__a">
      <div>
        @if (isset($elements[2]))
          ...
          @endif
          @if ($elements[2]->image)
            @include('frontend.partials.boxes.project.image', array('image' => $elements[2]->image, 'image_attribute' => 'height="639" width="450"'))
          @endif
        @endif
      </div>
    </div>
    ...
    <div class="box__a">
      <div>
        @if (isset($elements[3]))
          ...
          @endif
          @if ($elements[3]->image)
            @include('frontend.partials.boxes.project.image', array('image' => $elements[3]->image, 'image_attribute' => 'height="639" width="450"'))
          @endif
        @endif
      </div>
    </div>
